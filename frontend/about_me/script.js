...
const dialogues = {
  test1: [
    ...
    `Games: Persona, Hearts of Iron, Red Dead Redemption 2, Phoenix Wright, Genshin Impact [normal]`,
    `Anime: JoJo's, Chainsaw Man, Saiki K, Bocchi, Mushoku Tensei [happy]`,
  ...
  test2: [
    ...
    `The pages are inspired by Persona, "Milk outside a bag of milk outside a bag of milk", "Needy Streamer Overload", the Wii Menu,, Minecraft. [thinking]`,
    ...
    `Recently I have been working on a backend written in Golang for the Blog and Guestbook page. [thinking]`,
  ...
  test3: [
    ...
    `But I am still keeping up on my hobbies. I am currently playing the Phoenix Wright Trilogy, Genshin Impact and replaying Persona 5 Royal. I also still dabble with my GameCube and PSP. [happy]`,
    ...
    `Of course I am currently programming this website but I also try to do other stuff in my free time like learning more Golang and Linux desktops. (I use Arch and Hyprland btw) [thinking]`,
  ...
  test4: [
    ...
    `For more "unknown" anime I can recommend Mushoku Tensei, Saiki k, A Place Further than The Universe, Bocchi, Look Back and Grand Blue. [happy]`,
    `These recommendations already feel too mainstream, not good. Take a look at my accounts as I said, you can get a bigger picture there. [paranoid]`,
...
function handleDialogueClick() {
  if (isTyping) {
    ...
    dialogueText.textContent = currentCleanText;
    isTyping = false;
    return;
  }
